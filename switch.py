...
class GameEnv:
    def __init__(self, hig=0.6, widht=34, hight=7):
        self.size_x = widht
        self.size_y = hight
        self.objects = []
    ...
    def contribute_metrix(self, ag=None):
        ...
        if not self.agent1_food.is_hidden():
            if ag is not None and ag==1 and True:
                ...
                a[self.agent1_food.y + 1, self.agent1_food.x + 1, 0] = 117 / 255
                a[self.agent1_food.y + 1, self.agent1_food.x + 1, 1] = 255 / 255
                a[self.agent1_food.y + 1, self.agent1_food.x + 1, 2] = 0
        ...
        if not self.agent2_food.is_hidden():
            if ag is not None and ag==1 and True:
                ...
                a[self.agent2_food.y + 1, self.agent2_food.x + 1, 0] = 12 / 255
                a[self.agent2_food.y + 1, self.agent2_food.x + 1, 1] = 255 / 255
                a[self.agent2_food.y + 1, self.agent2_food.x + 1, 2] = 134 / 255
